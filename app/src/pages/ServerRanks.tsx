...
const ranksData = [
  {
    ...
    perks: [
      ...
      { name: 'Color Picker', active: true },
      { name: 'Silent Chess Access', active: true },
      { name: '/launch Command', active: false },
  ...
  },
  {
    ...
    perks: [
      { name: 'Chat Badge', active: true },
      { name: 'AFK', active: true },
      { name: '/ender Chest', active: true },
      { name: '/repair Items', active: true },
      { name: '/options Command', active: true },
      { name: 'Kit VIP', active: true },
      { name: '/heal Command', active: false },
      { name: '/nick (Nickname)', active: false },
      { name: '/back Command', active: false },
      { name: '/feed Command', active: false },
    ]
  },
  {
    name: 'Hero',
    ...
    perks: [
      ...
      { name: '/feed Command', active: true },
      { name: '/glow Command', active: true },
      { name: '/hat Command', active: true },
      { name: 'Kit Elite', active: true },
      { name: '/near Command', active: true },
      { name: '/back Command', active: true },
      { name: '/heal Command', active: false },
      { name: 'Entity Info', active: false },
    ]
  },
  {
    name: 'Nexus',
    ...
    perks: [
      ...
      { name: '/pweather (Weather)', active: true },
      { name: 'Portable Anvil', active: true },
      { name: 'Kit Hero', active: true },
      { name: 'Entity Info', active: true },
      { name: 'Find Biome', active: true },
      { name: '/back Command', active: true },
      { name: 'Scavenge Items', active: true },
    ]
  },
  {
    name: 'Phantom',
    ...
    perks: [
      { name: 'Chat Badge', active: true },
      { name: 'Mail All Players', active: true },
      { name: '/launch Commmand', active: true },
      { name: '/burn Command', active: true },
      { name: '/ignore Players', active: true },
      { name: '/scale Command', active: true },
      { name: '/heal Command', active: true },
      { name: 'Check Warning', active: true },
      { name: 'All Previous Perks', active: true },
      { name: 'Ultimate Status', active: true },
    ]
  }
];
